/**
 * 📋 DIVE LOG AUDIT ENDPOINT - /api/chat/audit.js
 * 
 * PURPOSE: Handles dive log audit requests triggered from chat interactions
 * FEATURES:
 * - Detects "yes" responses to audit offers in chat
 * - Fetches recent dive logs for technical analysis
 * - Triggers detailed pattern and performance analysis
 * - Provides in-depth coaching recommendations
 * 
 * COMMUNICATION: Supabase dive logs → Analysis
 * USERS: Users who request detailed dive log audits
 * 
 * USAGE: Automatically triggered when user confirms audit request in chat
 */
