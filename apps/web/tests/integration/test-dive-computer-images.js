...
console.log('   SERVICE_ROLE_KEY (first 20 chars):', process.env.SUPABASE_SERVICE_ROLE_KEY ? process.env.SUPABASE_SERVICE_ROLE_KEY.slice(0, 20) + '...' : '❌ Missing');
...
// Use anon key since it works and we can configure RLS properly
