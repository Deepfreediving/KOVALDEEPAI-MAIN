        ...
        <div className="flex-1 overflow-hidden">
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {/* Same content as embedded version goes here */}
              {activeTab === 'saved-logs' && (
                <div className="text-center">
                  <p className="text-gray-500">Popup mode content goes here...</p>
                </div>
              )}
              {activeTab === 'add-new' && (
                <div className="text-center">
                  <p className="text-gray-500">Popup form content goes here...</p>
                </div>
              )}
            </div>
          </div>
