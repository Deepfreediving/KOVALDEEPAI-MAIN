...
setTimeout(() => {
  if (!messageReceived) {
    console.log('ℹ️ No USER_DATA_RESPONSE received - may indicate V4.0 or earlier');
    window.removeEventListener('message', messageListener);
  }
}, 3000);
...
console.log('4. Verify the saved log in DiveLogs collection has correct member ID');
