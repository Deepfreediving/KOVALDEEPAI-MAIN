...
export const createMessage = async (threadId, message) => {
  try {
    ...
    const response = await openaiApi.post('/chat/completions', {
      ...
      // Here, you can pass the file IDs to assist with the conversation if required
      // This step assumes you are using file search capabilities or providing context
      // For example, you might need to integrate Pinecone for knowledge retrieval.
