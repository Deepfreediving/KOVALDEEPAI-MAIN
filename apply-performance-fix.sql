-- ================================================================
-- EMERGENCY PERFORMANCE FIX FOR ERR_INSUFFICIENT_RESOURCES
-- ================================================================
-- Apply this directly to your Supabase database via SQL Editor
-- This will fix the performance issues immediately

-- 1. Add critical indexes for dive logs query performance
...
-- 2. Add indexes for dive_log_image table to prevent N+1 queries
...
-- 3. Create optimized view for single-query dive logs with images
...
-- 4. Create admin-specific optimized view for the problematic user
...
-- 5. Add partial indexes for recent data (most queries are for recent records)
...
-- 7. Verify the indexes were created
SELECT 
    schemaname, 
    tablename, 
    indexname, 
...
WHERE schemaname = 'public' 
    AND indexname LIKE 'idx_dive_log%'
