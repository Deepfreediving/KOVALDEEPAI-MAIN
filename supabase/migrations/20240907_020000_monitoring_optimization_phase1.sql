...
CREATE INDEX IF NOT EXISTS idx_usage_analytics_timestamp_brin 
ON usage_analytics USING BRIN (timestamp) WITH (pages_per_range = 128);

CREATE INDEX IF NOT EXISTS idx_error_logs_timestamp_brin 
...
CREATE INDEX IF NOT EXISTS idx_usage_analytics_endpoint_timestamp 
...
WHERE relname IN ('usage_analytics', 'error_logs', 'performance_metrics', 'cost_budgets', 'cost_alerts')
