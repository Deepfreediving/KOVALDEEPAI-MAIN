...
console.log(
  "🔍 Testing Complete Compressed Flow: Frontend ↔ Backend ↔ DiveLogs Collection\n",
);
...
try {
  ...
  const { diveLogRecord, backendResponse } =
    simulateBackendProcessing(frontendRequest);
  ...
  console.log(
    "Progression Score:",
    backendResponse.compressedStructure.progressionScore + "%",
  );
  console.log("Risk Factors:", backendResponse.compressedStructure.riskFactors);
  console.log(
    "Depth Achievement:",
    backendResponse.compressedStructure.depthAchievement + "%",
  );
  ...
  if (frontendParsedData) {
    ...
    console.log(
      "Depths:",
      `${frontendParsedData.depths.reached}m / ${frontendParsedData.depths.target}m`,
    );
    console.log("Photo:", frontendParsedData.photo);
    console.log(
      "Analysis Score:",
      frontendParsedData.analysis.progressionScore + "%",
    );
  ...
  console.log(
    "✅ Risk assessment:",
    aiData.analysis.riskFactors.length > 0 ? "Issues detected" : "No issues",
  );
  console.log("✅ Technical details:", !!aiData.analysis.technicalNotes);
  console.log(
    "✅ Progression tracking:",
    aiData.analysis.progressionScore + "%",
  );
