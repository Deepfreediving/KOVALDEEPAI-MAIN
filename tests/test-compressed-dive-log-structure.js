...
function createCompressedDiveLogStructure(diveLogData, userId = 'test-user-123') {
...
try {
  ...
  const { compressedLogEntry, diveLogRecord } = createCompressedDiveLogStructure(sampleDiveLog);
  ...
  console.log('\n🤖 AI Analysis Fields:');
  console.log('======================');
  console.log('Progression Score:', parsedLogEntry.analysis.progressionScore + '%');
  console.log('Depth Achievement:', parsedLogEntry.analysis.depthAchievement.toFixed(1) + '%');
  console.log('Risk Factors:', parsedLogEntry.analysis.riskFactors.join(', ') || 'None');
  console.log('Technical Notes:', parsedLogEntry.analysis.technicalNotes || 'None');
  ...
  console.log('📈 This structure is perfect for AI analysis and sidebar display');
