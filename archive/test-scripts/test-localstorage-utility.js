...
function testLocalStorageForDiveLogs() {
  ...
  console.log("\n2. 🆔 USER ID TEST:");
  const userId =
    window.wixUserId || window.KOVAL_USER_DATA_V5?.userId || "test-user";
  console.log("   • Current user ID:", userId);
  console.log(
    "   • Is real member ID:",
    !userId.startsWith("session-") && !userId.startsWith("guest-")
      ? "✅ Yes"
      : "❌ No (session/guest ID)",
  );
  ...
  console.log(
    '✅ Check the console for any "localStorage verification" messages',
  );
