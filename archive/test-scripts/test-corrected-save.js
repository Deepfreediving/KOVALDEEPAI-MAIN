  ...
  try {
    ...
    if (result.success) {
      ...
      const checkResponse = await fetch(
        `/api/analyze/get-dive-logs?userId=${testDiveLog.userId}`,
      );
...
console.log(
  "🎯 The problem was using query-wix-data for INSERT instead of save-wix-data",
);
console.log(
  "🔧 Now using the correct API endpoints for saving to DiveLogs collection",
);
