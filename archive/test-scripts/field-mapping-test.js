  ...
  if (typeof tryWixCollectionSave === "function") {
    ...
    tryWixCollectionSave(testLogWithCorrectFields)
      .then((result) => {
        ...
        console.log(
          "🔍 Check Wix Editor > Database > DiveLogs for the new entry",
        );
      })
      .catch((error) => {
...
if (typeof wixData !== "undefined" && wixData.save) {
  ...
  wixData
    ...
    .then((result) => {
      console.log(
        "🎉 DIRECT SAVE SUCCESS! Field mapping is working:",
        result._id,
      );
...
console.log(
  "4. If successful, try saving a real dive log through the AI widget",
);
console.log("================================================");
